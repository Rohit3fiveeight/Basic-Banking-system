         ...
         if(m!=null)
         {
            ...
            %>
             ...
             <div class="center mt-0 #ffab00 accent-3">
                <h3><b><span></span>All Citizens Bank</b></h3>
            </div>
            ...
            <form id="reg-form" action="TransferController" method ="POST">        
                <div class="container">
                <br><br>
                ...
                <select id="to" name="transferfrom" class="form-control" required>
                    <option  disabled selected>Choose</option>
                        <%
                            UserDao postd=new UserDao(DbConnection.getConnection());
                ...
                <select id="to" name="transferto" class="form-control" required>
                    <option  disabled selected>Choose</option>
                        <%
                             postd=new UserDao(DbConnection.getConnection());
