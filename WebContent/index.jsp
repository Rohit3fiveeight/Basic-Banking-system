...
<html>
    ...
    * {
    ...
    <div class="center mt-0 #ffab00 accent-3">
      <h2><b><span></span>All Citizens BANK</b></h2>
    </div>
  <!---3 col start-->
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
              ...
              <img class="cust" src="download.jfif" style="height:180px;width:300px;align:center">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="download5.jfif" style="height:190px;width:405px;align:center" >
            </div>
            
            <h5><b>Welcome to All Citizens Bank !</b></h5>
            <br />
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="images.png" style="height:180px;width:300px;align:center">
            </div>
